...
public static class FieldTypeExtensions
{
    ...
    public static bool UsesMemoFile(this FieldType fieldType) => fieldType switch
    {
        FieldType.Memo => true,
    ...
    public static Type GetExpectedNetType(this FieldType fieldType) => fieldType switch
    {
    ...
    public static bool SupportsNull(this FieldType fieldType) => fieldType switch
    {
