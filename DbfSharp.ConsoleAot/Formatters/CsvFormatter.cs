...
public sealed class CsvFormatter : IDbfFormatter
{
    ...
    public CsvFormatter(char delimiter = ',', FormatterConfiguration? options = null)
    {
    ...
    /// </summary>
    public static CsvFormatter Csv(FormatterConfiguration? options = null)
    {
    ...
    /// </summary>
    public static CsvFormatter Tsv(FormatterConfiguration? options = null)
    {
        return new CsvFormatter('\t', options);
    }
    ...
    {
        var format = _configuration.DateFormat ?? "yyyy-MM-dd HH:mm:ss";
